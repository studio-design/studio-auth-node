 ...
 */
export declare const OrganizationMemberDomainType: {
...
export declare const OrganizationRole: {
    ...
    readonly SECURITY_ADMIN: "security_admin";
 ...
 */
export declare const TokenErrorCode: {
 ...
 */
export declare const RevokeErrorCode: {
    readonly INVALID_REQUEST: "invalid_request";
    readonly INVALID_CLIENT: "invalid_client";
    readonly UNSUPPORTED_TOKEN_TYPE: "unsupported_token_type";
};
/**
 * RFC 7009 Section 2.2.1 および RFC 6749 Section 5.2 で定義される
 * `/oauth/revoke` エンドポイントのエラーコード。
 ...
 * - `invalid_client`: クライアント認証失敗（未知のクライアント、認証情報なし、サポートされていない認証方式）
 */
export declare const IntrospectErrorCode: {
    readonly INVALID_REQUEST: "invalid_request";
    readonly INVALID_CLIENT: "invalid_client";
};
/**
 ...
 */
export declare const OauthAuthorizeErrorCode: {
    readonly INVALID_REQUEST: "invalid_request";
 ...
 */
export declare const IdpAuthorizeErrorCode: {
 ...
 */
export declare const JwkKeyType: {
    readonly RSA: "RSA";
    readonly EC: "EC";
};
/**
 ...
 * 署名検証用の場合は `sig`。
 */
export declare const JwkKeyUse: {
    readonly SIG: "sig";
};
/**
 * 公開鍵の用途 (Public Key Use, RFC 7517)。
 ...
 */
export declare const JwkSigningAlg: {
 ...
 */
export declare const ScopeValue: {
 ...
 */
export declare const OrganizationMemberSortBy: {
    readonly NAME: "name";
    readonly EMAIL: "email";
    readonly ROLE: "role";
 ...
 * - `audit_log`: 監査ログの閲覧画面
 */
export declare const AdminPortalIntent: {
    readonly SSO: "sso";
 ...
 * 外部プロバイダ (WorkOS) API 呼び出しに失敗した場合は `none` を返却します。
 */
export declare const SsoConnectionStatus: {
