 ...
 */
export const getServiceInfo = (options) => (options?.client ?? client).get({ url: '/', ...options });
/**
 ...
 */
export const getOpenIdConfiguration = (options) => (options?.client ?? client).get({ url: '/.well-known/openid-configuration', ...options });
/**
 * ヘルスチェック
 *
 * サービスの稼働状況を確認するためのヘルスチェックエンドポイントです。
 */
export const getHealthStatus = (options) => (options?.client ?? client).get({ url: '/health', ...options });
/**
 ...
 */
export const getJwks = (options) => (options?.client ?? client).get({ url: '/jwks', ...options });
/**
 * 認可フローの開始
 *
 ...
 */
export const initiateAuthorization = (options) => (options.client ?? client).get({ url: '/oauth/authorize', ...options });
/**
 * IdP コールバック処理
 *
 ...
 */
export const handleIdpCallback = (options) => (options?.client ?? client).get({ url: '/oauth/callback', ...options });
/**
 * トークンエンドポイント
 *
 ...
 */
export const issueTokens = (options) => (options.client ?? client).post({
 ...
 */
export const getUserinfo = (options) => (options?.client ?? client).get({
 ...
 */
export const postUserinfo = (options) => (options?.client ?? client).post({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/oauth/userinfo',
    ...options
});
 ...
 */
export const revokeToken = (options) => (options.client ?? client).post({
    ...urlSearchParamsBodySerializer,
    security: [{ scheme: 'basic', type: 'http' }],
    url: '/oauth/revoke',
    ...options,
 ...
 */
export const introspectToken = (options) => (options.client ?? client).post({
    ...urlSearchParamsBodySerializer,
    security: [{ scheme: 'basic', type: 'http' }],
 ...
 */
export const endSession = (options) => (options?.client ?? client).get({ url: '/oauth/logout', ...options });
/**
 * ログアウトエンドポイント (POST)
 *
 ...
 */
export const endSessionPost = (options) => (options?.client ?? client).post({
    ...urlSearchParamsBodySerializer,
    url: '/oauth/logout',
    ...options,
    headers: {
 ...
 * **認証**: 管理者権限を持つ Bearer トークンが必要です。
 */
export const deleteClient = (options) => (options.client ?? client).delete({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * **認証**: 管理者権限を持つ Bearer トークンが必要です。
 */
export const removeOrganizationMember = (options) => (options.client ?? client).delete({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * **認証**: 管理者権限を持つ Bearer トークンが必要です。
 */
export const updateOrganizationMemberRole = (options) => (options.client ?? client).patch({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/admin/organizations/{organization_id}/members/{member_id}',
    ...options,
    headers: {
 ...
 */
export const createAdminPortalSession = (options) => (options.client ?? client).post({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const sendInvitation = (options) => (options.client ?? client).post({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * **認可**: リクエストユーザーが対象組織のメンバーであることが必要です（ロール不問）。
 */
export const listMembers = (options) => (options.client ?? client).get({
    querySerializer: { parameters: { role: { array: { explode: false } }, domain_type: { array: { explode: false } } } },
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * **認可**: リクエストユーザーが対象組織のメンバーであることが必要です（ロール不問）。
 */
export const getMemberMe = (options) => (options.client ?? client).get({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * - Admin / Security Admin / Member は最低人数制約なく削除可能です（Owner が Admin / Security Admin の業務を全て遂行できるため）。
 */
export const removeMember = (options) => (options.client ?? client).delete({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const checkSsoEnforcement = (options) => (options?.client ?? client).get({
    security: [{ scheme: 'basic', type: 'http' }],
