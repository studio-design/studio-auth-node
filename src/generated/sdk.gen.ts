 ...
 */
export const getServiceInfo = <ThrowOnError extends boolean = false>(options?: Options<GetServiceInfoData, ThrowOnError>): RequestResult<GetServiceInfoResponses, GetServiceInfoErrors, ThrowOnError> => (options?.client ?? client).get<GetServiceInfoResponses, GetServiceInfoErrors, ThrowOnError>({ url: '/', ...options });
 ...
 */
export const getOpenIdConfiguration = <ThrowOnError extends boolean = false>(options?: Options<GetOpenIdConfigurationData, ThrowOnError>): RequestResult<GetOpenIdConfigurationResponses, GetOpenIdConfigurationErrors, ThrowOnError> => (options?.client ?? client).get<GetOpenIdConfigurationResponses, GetOpenIdConfigurationErrors, ThrowOnError>({ url: '/.well-known/openid-configuration', ...options });
 ...
 */
export const getHealthStatus = <ThrowOnError extends boolean = false>(options?: Options<GetHealthStatusData, ThrowOnError>): RequestResult<GetHealthStatusResponses, GetHealthStatusErrors, ThrowOnError> => (options?.client ?? client).get<GetHealthStatusResponses, GetHealthStatusErrors, ThrowOnError>({ url: '/health', ...options });
 ...
 */
export const getJwks = <ThrowOnError extends boolean = false>(options?: Options<GetJwksData, ThrowOnError>): RequestResult<GetJwksResponses, GetJwksErrors, ThrowOnError> => (options?.client ?? client).get<GetJwksResponses, GetJwksErrors, ThrowOnError>({ url: '/jwks', ...options });
 ...
 */
export const initiateAuthorization = <ThrowOnError extends boolean = false>(options: Options<InitiateAuthorizationData, ThrowOnError>): RequestResult<unknown, InitiateAuthorizationErrors, ThrowOnError> => (options.client ?? client).get<unknown, InitiateAuthorizationErrors, ThrowOnError>({ url: '/oauth/authorize', ...options });
 ...
 */
export const issueTokens = <ThrowOnError extends boolean = false>(options: Options<IssueTokensData, ThrowOnError>): RequestResult<IssueTokensResponses, IssueTokensErrors, ThrowOnError> => (options.client ?? client).post<IssueTokensResponses, IssueTokensErrors, ThrowOnError>({
 ...
 */
export const postUserinfo = <ThrowOnError extends boolean = false>(options?: Options<PostUserinfoData, ThrowOnError>): RequestResult<PostUserinfoResponses, PostUserinfoErrors, ThrowOnError> => (options?.client ?? client).post<PostUserinfoResponses, PostUserinfoErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/oauth/userinfo',
    ...options
});
 ...
 */
export const introspectToken = <ThrowOnError extends boolean = false>(options: Options<IntrospectTokenData, ThrowOnError>): RequestResult<IntrospectTokenResponses, IntrospectTokenErrors, ThrowOnError> => (options.client ?? client).post<IntrospectTokenResponses, IntrospectTokenErrors, ThrowOnError>({
    ...urlSearchParamsBodySerializer,
    security: [{ scheme: 'basic', type: 'http' }],
 ...
 */
export const endSession = <ThrowOnError extends boolean = false>(options?: Options<EndSessionData, ThrowOnError>): RequestResult<EndSessionResponses, EndSessionErrors, ThrowOnError> => (options?.client ?? client).get<EndSessionResponses, EndSessionErrors, ThrowOnError>({ url: '/oauth/logout', ...options });
 ...
 */
export const endSessionPost = <ThrowOnError extends boolean = false>(options?: Options<EndSessionPostData, ThrowOnError>): RequestResult<EndSessionPostResponses, EndSessionPostErrors, ThrowOnError> => (options?.client ?? client).post<EndSessionPostResponses, EndSessionPostErrors, ThrowOnError>({
    ...urlSearchParamsBodySerializer,
    url: '/oauth/logout',
    ...options,
    headers: {
 ...
 */
export const lookupPendingAuthentication = <ThrowOnError extends boolean = false>(options: Options<LookupPendingAuthenticationData, ThrowOnError>): RequestResult<LookupPendingAuthenticationResponses, LookupPendingAuthenticationErrors, ThrowOnError> => (options.client ?? client).post<LookupPendingAuthenticationResponses, LookupPendingAuthenticationErrors, ThrowOnError>({
 ...
 * **認証**: 管理者権限を持つ Bearer トークンが必要です。
 */
export const updateClient = <ThrowOnError extends boolean = false>(options: Options<UpdateClientData, ThrowOnError>): RequestResult<UpdateClientResponses, UpdateClientErrors, ThrowOnError> => (options.client ?? client).patch<UpdateClientResponses, UpdateClientErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/admin/clients/{client_id}',
    ...options,
    headers: {
 ...
 * **認証**: 管理者権限を持つ Bearer トークンが必要です。
 */
export const createOrganizationInvitation = <ThrowOnError extends boolean = false>(options: Options<CreateOrganizationInvitationData, ThrowOnError>): RequestResult<CreateOrganizationInvitationResponses, CreateOrganizationInvitationErrors, ThrowOnError> => (options.client ?? client).post<CreateOrganizationInvitationResponses, CreateOrganizationInvitationErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/admin/organizations/{organization_id}/invitations',
    ...options,
    headers: {
 ...
 */
export const createAdminPortalSession = <ThrowOnError extends boolean = false>(options: Options<CreateAdminPortalSessionData, ThrowOnError>): RequestResult<CreateAdminPortalSessionResponses, CreateAdminPortalSessionErrors, ThrowOnError> => (options.client ?? client).post<CreateAdminPortalSessionResponses, CreateAdminPortalSessionErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const getMyOrganization = <ThrowOnError extends boolean = false>(options: Options<GetMyOrganizationData, ThrowOnError>): RequestResult<GetMyOrganizationResponses, GetMyOrganizationErrors, ThrowOnError> => (options.client ?? client).get<GetMyOrganizationResponses, GetMyOrganizationErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const updateMyOrganization = <ThrowOnError extends boolean = false>(options: Options<UpdateMyOrganizationData, ThrowOnError>): RequestResult<UpdateMyOrganizationResponses, UpdateMyOrganizationErrors, ThrowOnError> => (options.client ?? client).patch<UpdateMyOrganizationResponses, UpdateMyOrganizationErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
    url: '/organizations/{organization_id}',
    ...options,
    headers: {
 ...
 */
export const sendInvitation = <ThrowOnError extends boolean = false>(options: Options<SendInvitationData, ThrowOnError>): RequestResult<SendInvitationResponses, SendInvitationErrors, ThrowOnError> => (options.client ?? client).post<SendInvitationResponses, SendInvitationErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * **認可**: リクエストユーザーが対象組織のメンバーであることが必要です（ロール不問）。
 */
export const getMemberMe = <ThrowOnError extends boolean = false>(options: Options<GetMemberMeData, ThrowOnError>): RequestResult<GetMemberMeResponses, GetMemberMeErrors, ThrowOnError> => (options.client ?? client).get<GetMemberMeResponses, GetMemberMeErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const createMyAdminPortalSession = <ThrowOnError extends boolean = false>(options: Options<CreateMyAdminPortalSessionData, ThrowOnError>): RequestResult<CreateMyAdminPortalSessionResponses, CreateMyAdminPortalSessionErrors, ThrowOnError> => (options.client ?? client).post<CreateMyAdminPortalSessionResponses, CreateMyAdminPortalSessionErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const checkSsoEnforcement = <ThrowOnError extends boolean = false>(options?: Options<CheckSsoEnforcementData, ThrowOnError>): RequestResult<CheckSsoEnforcementResponses, CheckSsoEnforcementErrors, ThrowOnError> => (options?.client ?? client).get<CheckSsoEnforcementResponses, CheckSsoEnforcementErrors, ThrowOnError>({
    security: [{ scheme: 'basic', type: 'http' }],
